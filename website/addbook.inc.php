...
if (isset($_SESSION['login'])) {
  ...
  if ((trim($book_id) == '') or (!is_numeric($book_id))) {
    ...
    $book_code = htmlspecialchars($_POST['book_code']);
    ...
    $book_genre_id = is_int($_POST['book_genre_id']);
    $book_buy_price = is_float($_POST['book_buy_price']);
    $book_sell_price = is_float($_POST['book_sell_price']);
